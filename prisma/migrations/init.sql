...
CREATE TABLE `budgets` (
    ...
    UNIQUE INDEX `budgets_userId_category_period_key`(`userId`, `category`, `period`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- CreateTable
CREATE TABLE `simulated_expenses` (
    `id` VARCHAR(191) NOT NULL,
...
-- AddForeignKey
ALTER TABLE `simulated_expenses` ADD CONSTRAINT `simulated_expenses_simulationId_fkey` FOREIGN KEY (`simulationId`) REFERENCES `simulations`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;